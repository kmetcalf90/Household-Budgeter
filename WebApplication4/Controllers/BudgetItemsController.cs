...
namespace WebApplication4.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Frequency,CategoryId,BudgetId,Amount,Active")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Frequency,CategoryId,BudgetId,Amount,Active")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
